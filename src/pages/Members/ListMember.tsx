...
const ListMember = observer((props: any) => {
  ...
  let listSelected: [] = [];
  const viewModel = props.viewModel.memberListViewModel;
  ...
  const deleteMembers = () => {
    if (listSelected.length < 1) {
      ...
      viewModel.isLoading();
      viewModel.deleteMembers(listSelected);
    }
  };
      ...
      <div className="bg-white rounded">
        {viewModel?.successResponse?.state ? (
          <Table
            ...
            data={viewModel?.successResponse?.listMembers}
...
export default withTranslation()(withMemberViewModel(ListMember));
