...
const checkMintWeb3IDNFT = async (account: any, connection: any) => {
  const data = await invokeSmartContract(
    connection,
    account,
    process.env.NEXT_PUBLIC_SMARTCONTRACT_NFT_WEBE3ID_NAME,
    process.env.NEXT_PUBLIC_SMARTCONTRACT_NFT_WEBE3ID_INDEX,
    process.env.NEXT_PUBLIC_SMARTCONTRACT_NFT_WEBE3ID_SUBINDEX,
